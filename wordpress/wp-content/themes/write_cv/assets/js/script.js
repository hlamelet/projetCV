...
function changeCenter(){
  document.getElementById("overlay-content2").innerHTML =
    '<h5 style="color: white;">Alignement du texte</h5><button onclick="rightFont()" id="right" class="font_general2">à droite</button><button onclick="centerFont()" id="center" class="font_general2">Au milieu</button><button onclick="leftFont()" id="left" class="font_general2">à gauche</button><button onclick="justifyFont()" id="justify" class="font_general2">Justifié</button>';
}
