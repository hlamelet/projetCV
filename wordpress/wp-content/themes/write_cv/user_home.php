                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="nameField" name="name" placeholder="John Morroy" class="form-control" />
                            </div>

                            <div class="form-group mt-2">
                                <label for="contactField"></label>
                                <input type="text" id="contactField" name="tel" placeholder="0658453623" class="form-control" />
                            </div>
...
<div id="bloc_principal_user">
    blabla
                    ...
                    <div class="container text-center mt-3">
                        <input value="Créer mon CV" type="button" id="submit" class="btn btn-primary btn-lg" />                      
                    </div>
                </div>
            </div class="card-body">
